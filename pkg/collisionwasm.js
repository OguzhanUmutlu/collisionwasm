 ...
 * @param {number} width_a
 * @param {number} height_a
 * @param {number} offset_x_a
 * @param {number} offset_y_a
 * @param {Uint8Array} data_b
 * @param {number} width_b
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('collisionwasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
